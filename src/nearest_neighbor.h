...
class NearestNeighborInterface {
 public:
  ...
  virtual std::vector<NodeWithCost> nearest_neighbors(NodePtr node,
                                                      size_t k) const = 0;

  virtual std::vector<NodeWithCost> radius_search(NodePtr node,
...
class LinearSearchNN : public NearestNeighborInterface {
 public:
  ...
  std::vector<NodeWithCost> nearest_neighbors(NodePtr node,
                                              size_t k) const override;

  std::vector<NodeWithCost> radius_search(NodePtr node,
